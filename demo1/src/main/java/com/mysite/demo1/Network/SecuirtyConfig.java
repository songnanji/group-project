    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/error","/","/api/signup","/api/login","/api/movies/search","api/movies/**","/api/movies/random","/api/board","/api/board/**","api/comments","api/comments/**","api/change-password","/h2-console/**","/api/reviews","/api/reviews/movie/**").permitAll() // /api/signup 경로 허용
